...
from biztest.config.gbiz.gbiz_beiyin_daqin_config import *
...
@pytest.mark.gbiz_beiyin_daqin
class TestBeiyinDaqin(BaseTestCapital):
    def init(self):
        super(TestBeiyinDaqin, self).init()
        self.channel = "beiyin_daqin"
        self.capital_mock = beiyinDaqinMock(gbiz_mock)
        update_gbiz_capital_beiyin_daqin()
        update_gbiz_capital_beiyin_daqin_const()
        update_all_channel_amount()
    ...
    @pytest.mark.gbiz_beiyin_daqin
    @pytest.mark.gbiz_beiyin_daqin_loan_success
    ...
    def test_beiyin_daqin_loan_success(self, case, app, source_type, period):
        """
        放款成功
        """
    ...
    def test_beiyin_daqn_canloan_fail(self, case, app, source_type, period):
        """
        canloan失败切资方
        :param app:
        :param source_type:
        ...
        check_wait_change_capital_data(item_no, 4, "beiyin_daqin->校验资金量失败;", "AssetCanLoanFailedEvent")

    @pytest.mark.gbiz_beiyin_daqin
    @pytest.mark.parametrize("app, source_type, period", [("香蕉", "apr36", 12)])
    def test_beiyin_daqn_apply_fail(self, case, app, source_type, period):
        """
        LoanApplyNew 失败切资方
        :param app:
        :param source_type:
    ...
    @pytest.mark.gbiz_beiyin_daqin
    @pytest.mark.parametrize("app, source_type, period", [("香蕉", "apr36", 12)])
    def test_beiyin_daqn_applequery_fail(self, case, app, source_type, period):
        """
    ...
    @pytest.mark.gbiz_beiyin_daqin
    @pytest.mark.parametrize("app, source_type, period", [("香蕉", "apr36", 12)])
    def test_beiyin_daqn_creditapply_fail(self, case, app, source_type, period):
        """
    ...
    @pytest.mark.gbiz_beiyin_daqin
    @pytest.mark.parametrize("app, source_type, period", [("香蕉", "apr36", 12)])
    def test_beiyin_daqn_confirm_fail(self, case, app, source_type, period):
        """
    ...
    @pytest.mark.gbiz_beiyin_daqin
    @pytest.mark.parametrize("app, source_type, period", [("香蕉", "apr36", 12)])
    def test_beiyin_daqn_confirmquery_fail(self, case, app, source_type, period):
        """
