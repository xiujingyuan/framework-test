...
from biztest.util.easymock.rbiz.jinmeixin_daqin import RepayJinmeixinDaqinMock
...
@pytest.mark.rbiz_jinmeixin_daqin
class TestRbizJinmeixinDaqin(BaseRepayTest):
    """
    jinmeixin_daqin 还款

    """
    loan_channel = "jinmeixin_daqin"
    our_sign_company = "tq,tqa,tqb"
    grant_principal = 300000
    one_interest = 4350
    one_fee = 2720
    last_period_total = 30139

    @classmethod
    def setup_class(cls):
        monitor_check()
        update_repay_paysvr_config(mock_project['rbiz_auto_test']['id'])
        cls.jmxdq_mock = RepayJinmeixinDaqinMock(rbiz_mock)
    ...
    def test_active_normal_repay(self):
        ...
        """
        # step 1 主动还款 到期日
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_trial(self.item_no)
        ...
        # mock全额还款
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_query_success(self.item_no, withhold[0]['withhold_serial_no'],
        ...
        check_capital_push_request_log(self.item_no, self.loan_channel, "JinmeixinDaqinCapitalPush")
    ...
    def test_active_normal_part_repay(self):
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_trial(self.item_no, prin_amt=0, int_amt=0)
        ...
        # 检查大单的代扣
        param_loan_one = {
            "withhold_amount": 27419,
            "asset_tran_amount": 27419,
            "withhold_channel": self.loan_channel,
            "withhold_sign_company": None
        }
        check_withhold_by_serial_no(order_no_one, **param_loan_one)
        param_loan_two = {
            "withhold_amount": 2720,
            "asset_tran_amount": 2720,
            "withhold_channel": self.loan_channel,
            "withhold_sign_company": None
        }
    ...
    def test_active_advance_settle_payoff(self):
        ...
        """
        self.change_asset_due_at(0, -10)
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_trial_settle(self.item_no)
        # step 1 主动还款
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_query_settle_success(self.item_no, withhold[0]['withhold_serial_no'],
                                                                        "C" + withhold[0]['withhold_serial_no'],
        ...
        #  拆成2单，资方扣本3000元+息10元+fee27.2元，我方扣剩余费用
        capital_withhold = {
            "withhold_sign_company": None,
            "withhold_channel": self.loan_channel,
    ...
    def test_active_advance_settle_part_payoff(self):
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_trial(self.item_no, prin_amt=0, int_amt=0, repay_type="PRE")
    ...
    def test_active_normal_last_period(self):
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_trial(self.item_no, prin_amt=270.20, int_amt=3.99, term_no=12)
        asset_tran_amount_two = get_asset_tran_balance_amount_by_item_no_and_period(self.item_no)
        params_combo_active = {
            "project_num_loan_channel_amount": int(asset_tran_amount_two["asset_tran_balance_amount"]),
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_query_success(self.item_no, withhold[0]['withhold_serial_no'],
                                                                 "C" + withhold[0]['withhold_serial_no'],
                                                                 prin_amt=270.20, int_amt=3.99, term_no=12)
        self.run_all_task_after_repay_success()
    ...
    def test_active_overdue_normal(self):
        ...
        # 第1单 资方扣 1期本息费
        param_loan_one = {
            "withhold_amount": 30139,
            "asset_tran_amount": 30139,
            "withhold_channel": self.loan_channel,
            "withhold_sign_company": None
        }
        check_withhold_by_serial_no(order_no_one, **param_loan_one)
    ...
    def test_active_overdue_compensate(self):
        ...
        check_capital_push_request_log(self.item_no, self.loan_channel + "_notify_capital", "JinmeixinDaqinCapitalPush",
    ...
    def test_active_part_repay_fee_overdue(self):
        ...
        check_data(capital_notify_info["repayNotifyReqDto"], repayStatus='SUCCESS', repayAmt=27.20)
        check_capital_push_request_log(self.item_no, self.loan_channel + "_notify_capital", "JinmeixinDaqinCapitalPush",
                                       0, capital_notify_info["repayNotifyReqDto"])

        # step 4 发起主动代扣第3次 第二期  资方扣 本金=23403 利息=4016  fee=2720
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_trial(self.item_no, prin_amt=234.03, int_amt=40.16, term_no=2)
        params_combo_active = {
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_query_success(self.item_no, withhold[0]['withhold_serial_no'],
                                                                 "C" + withhold[0]['withhold_serial_no'],
                                                                 prin_amt=234.03, int_amt=40.16, repay_status="SUCCESS",
                                                                 term_no=2)
        self.run_all_task_after_repay_success(withhold=withhold)
    ...
    def test_active_advance_settle_fee_overdue_part_payoff(self):
        ...
        # step 4 发起主动代扣第3次 资方扣2fee=2720  我方扣 2利息
        self.change_asset_due_at(-2, -0)
        asset_tran_amount_p2 = get_asset_tran_balance_amount_by_item_no_and_period(self.item_no)
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_trial(self.item_no, prin_amt=0, int_amt=0, term_no=2)
        ...
        self.jmxdq_mock.mock_jinmeixin_daqin_repay_query_success(self.item_no, withhold[0]['withhold_serial_no'],
                                                                 "C" + withhold[0]['withhold_serial_no'],
                                                                 prin_amt=0, int_amt=0, repay_status="SUCCESS",
                                                                 term_no=2)
        self.run_all_task_after_repay_success(withhold=withhold)
