...
#
#
# class TestPaymentBaidu:
#     env = gc.ENV
#     env_test = get_env_dict(env)
#     db_test_payment = gc.PAYMENT_DB
#
#     @pytest.mark.payment
#     @pytest.mark.payment_baidu
#     def test_baidu_protocol(self):
#         """
#         百度快捷支付测试
#         :return:
#         """
#         self.four_element = get_four_element_in_payment("工商银行")
#         channel_name = "baidu_tq3_quick"
#         # 组装获取验证码参数
...
#     @pytest.mark.payment
#     @pytest.mark.payment_baidu
#     def test_baidu_withhold(self):
#         """
#         通联协议支付测试
#         :return:
#         """
#         self.four_element = get_four_element_in_payment("工商银行")
#         channel_name = "baidu_tq2"
#         params_card_num = self.four_element["bank_code_encrypt"]
#
#         # 发起代扣
#         resp_withhold_autopay = auto_withhold(self.four_element, channel_name)
...
#     @pytest.mark.payment
#     @pytest.mark.payment_baidu
#     def test_baidu_fullcard(self):
#         """
#         通联协议支付测试
#         :return:
#         """
#         self.four_element = get_four_element_in_payment("工商银行")
#         channel_name = "baidu_tq4_fc"
#         params_card_num = self.four_element["bank_code_encrypt"]
#
#         # 发起代扣
#         resp_withhold_autopay = auto_withhold(self.four_element, channel_name)
...
#             print("代扣结果不明确")
#
#     @pytest.mark.payment_withdraw
#     @pytest.mark.payment_baidu
#     def test_baidu_withdraw(self):
#         """
#         通联代付测试
#         :return:
#         """
#         self.four_element = get_four_element_in_payment("工商银行")
#         channel_name = "qsq_baidu_tq_quick"
#
#         # 发起代付
