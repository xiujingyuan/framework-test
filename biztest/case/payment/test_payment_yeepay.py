...
@pytest.mark.payment
@pytest.mark.payment_yeepay
class TestPaymentYeepay:
    env = gc.ENV
    env_test = get_env_dict(env)
    db_test_payment = gc.PAYMENT_DB

    def test_yeepay_protocol(self):
        """
        通联协议支付测试
        :return:
        """
        self.four_element = {'bank_code': '6226097555587501',
                             'bank_code_encrypt': 'enc_03_1723840_984',
        ...
        channel_name = "yeepay_tq1_protocol"
        sql = "delete from binding where `binding_card_num`='enc_03_1723840_984' " \
              "and `binding_channel_name`='yeepay_tq1_protocol';"
        ...
        # 更新绑卡数据
        sql = "update binding set `binding_status`=1, `binding_protocol_info`='' where `binding_card_num`=" \
              "'enc_03_1723840_984' and `binding_channel_name`='yeepay_tq1_protocol';"
        self.db_test_payment.do_sql(sql)
    ...
    def test_yeepay_withhold(self):
        ...
        self.four_element = {'bank_code': '6226097555587501',
                             ...
                             'user_name': '刘田宝',
                             'user_name_encrypt': 'enc_04_1723850_411'}
        channel_name = "yeepay_tq1_withhold"
        params_card_num = self.four_element["bank_code_encrypt"]
    ...
    def test_yeepay_withdraw(self):
        """
        通联代付测试
        :return:
        """
        self.four_element = get_four_element_in_payment()
        channel_name = "qsq_yeepay_tq1"
