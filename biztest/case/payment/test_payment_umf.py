...
#
#
# class TestPaymentUmf:
#     env = gc.ENV
#     env_test = get_env_dict(env)
#     db_test_payment = gc.PAYMENT_DB
#
#     @pytest.mark.payment_umf
#     def test_umf_protocol(self):
#         """
#         通联协议支付测试
#         :return:
#         """
#         self.four_element = {'bank_code': '6216603100008122884',
#                              'bank_code_encrypt': 'enc_03_2942687488181274624_141',
#                              'id_number': '620102198911157018',
#                              'id_number_encrypt': 'enc_02_1723860_422',
#                              'phone_number': '13739463055',
#                              'phone_number_encrypt': 'enc_01_1723870_533',
#                              'user_name': '刘田宝',
#                              'user_name_encrypt': 'enc_04_1723850_411'}
#         # self.four_element = get_four_element_in_payment(self.db_test_payment)
#         channel_name = "umf_tq_protocol"
#         # 组装获取验证码参数
...
#         assert resp_withhold_bind["code"] == 1, "绑卡成功"
#
...
#         assert binding_request_info[0]["binding_request_status"] == 1, "绑卡请求成功"
#
#         binding_info = get_binding_info_by_card_num(params_card_num)
#         assert binding_info[0]["binding_channel_name"] == channel_name, "绑卡通道"
#         assert binding_info[0]["binding_status"] == 2, "绑卡成功"
#
#         # 更新绑卡数据
#         sql = "update binding set `binding_status`=1, `binding_protocol_info`='UB202006290949590000000038472839|P20" \
#               "20062909495900000000047981592' where `binding_card_num`='enc_03_2942687488181274624_141' and " \
#               "`binding_channel_name`='umf_tq_protocol';"
#         self.db_test_payment.do_sql(sql)
#
#         # 发起代扣
...
#
#     @pytest.mark.payment_umf
#     def test_umf_withdraw(self):
#         """
#         通联代付测试
#         :return:
#         """
#         self.four_element = get_four_element_in_payment(self.db_test_payment)
#         channel_name = "qsq_umf_tq_protocol"
#
#         # 发起代付
