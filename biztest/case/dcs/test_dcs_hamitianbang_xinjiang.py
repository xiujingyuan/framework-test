...
from biztest.config.rbiz.rbiz_nacos_kv_config import update_repay_hamitianbang_xinjiang_config
...
class TestDcsHaMiTianBangXinjiang(BaseRepayTest):
    env_test = gc.ENV
    ...
    def setup_method(self):
        ...
        self.item_no = 'hmtbxj' + get_item_no()[:16]
    ...
    def test_hami_qsq_normal_repay(self):
        ...
        self.run_task_after_withhold_callback(order_list)
        # step 6 第二次发起主动代扣 代扣成功
        resp_repay2 = self.repay_apply_success(asset_tran_amount, asset_tran_amount_no_loan)
        order_list2 = [project["order_no"] for project in resp_repay2["data"]["project_list"]]
