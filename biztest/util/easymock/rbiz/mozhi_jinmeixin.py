...
class RepayMozhiJinmeixinMock(Easymock):
    def update_repay_result(self, repay_amount, due_bill_no, withhold_channel="", pay_status="SUCCESS"):
        # 不代偿不切我方代扣
        api = "/mozhi/jinmeixin/repay.result"
        mode = {
            "code": 0,
            "message": pay_status,
            "data": {
    ...
    def update_repay_list(self, due_bill_no, pre_principal, pre_interest, late_interest=0, term=1, status='REPAY'):
        api = "/mozhi/jinmeixin/repay.list"
    ...
    def update_repay_trail(self, principal, interest):
        api = "/mozhi/jinmeixin/repay.ext.trial"
