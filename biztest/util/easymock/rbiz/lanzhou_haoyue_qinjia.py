...
class RepayLanzhouHaoyueQinjiaMock(Easymock):

    def mock_lanzhou_haoyue_qinjia_repay_trial(self, loan_no, send_code="0000", send_flag="01", int_amt=10, prin_amt=519.62,
                                         fee_amt=29.26):
    ...
    def mock_lanzhou_haoyue_qinjia_settle_repay_notice(self, tran_code, tran_sn, send_code="9999", send_flag="01",
                                                 tran_state="S"):
    ...
    def mock_lanzhou_haoyue_qinjia_normal_repay_notice(self, tran_code, tran_sn, send_code="9999", send_flag="01",
                                                 tran_state="S"):
