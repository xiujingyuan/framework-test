...
class JinmeixinHanchenJfMock(Easymock):
    ...
    def update_bindcard_query_new_user(self):
        ...
        :return:
        """
        api = "/jingfa/jinmeixin_hanchen_jf/kuainiu/query/bindCardResultQuery"
        body = {
                  "code": 0,
                  "message": "success",
                  "data": {
    ...
    def update_bindcard_get_sms_verify(self):
        ...
        :return:
        """
        api = "/jingfa/jinmeixin_hanchen_jf/kuainiu/apply/preBindingCardApply"
        body = {
                "code": 0,
                "message": "success",
                "data": {
    ...
    def update_bindcard_confirm(self):
        ...
        :return:
        """
        api = "/jingfa/jinmeixin_hanchen_jf/kuainiu/apply/bindCardConfirm"
        body = {
              "code": 0,
              "message": "success",
              "data": {
    ...
    def update_creditapply_status(self, creditStatus='01', message='请求成功'):
        ...
        :return:
        """
        api = '/jingfa/jinmeixin_hanchen_jf/kuainiu/apply/creditApply'
        body = {
                  "code": 0,
                  "message": "success",
                  "data": {
    ...
    def update_quota_query(self):
        api = '/jingfa/jinmeixin_hanchen_jf/kuainiu/v2/query/quotaQuery'
        body = {
                "code": 0,
                "message": "success",
                "data": {
    ...
    def update_creditresult_query(self,startDate='20221021',endDate='20291231',quota=2000000,creditStatus='02',
        ...
        :return:
        """
        api = '/jingfa/jinmeixin_hanchen_jf/kuainiu/query/creditResultQuery'
        body = {
                  "code": 0,
                  "message": "success",
                  "data": {
    ...
    def update_loanapplyconfirm_success(self):
        ...
        loanStatus	贷款状态
            ...
            :return:
        """
        api = '/jingfa/jinmeixin_hanchen_jf/kuainiu/apply/loanApply'
        body = {
              "code": 0,
              "message": "success",
              "data": {
    ...
    def update_loanresult_query(self, asset_info, loanstatus='02', rejectcode='', remark=''):
       ...
       loanStatus	用信状态
            ...
            :return:
        """
        api = '/jingfa/jinmeixin_hanchen_jf/kuainiu/query/loanResultQuery'
        body = {
                "code": 0,
                "message": "success",
                "data": {
    ...
    def upate_repayplan_query(self, asset_info):
        ...
        :return:
        """
        api = '/jingfa/jinmeixin_hanchen_jf/kuainiu/query/repayPlanQuery'
