...
class BeiyinTianbangMock(Easymock):

    def update_access_success(self):
        api = "/mozhibeiyin/tianbang/user.access"
        mode = '''{
                  "code": 0,
                  "message": "成功",
                  "data": {
    ...
    def update_accountquery_nodata(self):
        api = "/mozhibeiyin/tianbang/bind.bankcard.list"
        mode = '''{
                    "code": 0,
                    "message": "成功",
                    "data": [ ]
    ...
    def update_get_sms_code_success(self):
        api = "/mozhibeiyin/tianbang/bind.bankcard"
        mode = '''{
                  "code": 0,
                  "message": "外层测试msg",
                  "data": {
    ...
    def update_verify_sms_success(self):
        api = "/mozhibeiyin/tianbang/bind.sms.verify"
        mode = '''{
                  "code": 0,//0成功，其他失败
    ...
    def update_user_credit_info_noactive(self):
        api = "/mozhibeiyin/tianbang/user.credit.info"
        mode = '''{
                    "code": 0,
                    "message": "成功",
                    "data": {
    ...
    def update_user_credit_info_refuse(self):
        ...
        mode = '''{
                 ...
                 '''
        self.update(api, mode)
    def updare_user_credit_info_loan_refuse_in30day(self):
        #30天内借款被拒，授信查询返回如下：
        api="/mozhibeiyin/tianbang/user.credit.info"
        mode={
              "code": 0,
              ...
              "data": {
                ...
                "remainLimit": 2000000,
                "identity": None,
                "limitUseErrStatus": "OTHER_ERR",
                "creditLimit": 3500000,
                "limitType": "CIRCLE",
                "limitUseErrDesc": "很抱歉，暂时无法提供借款服务。",
                "repayDay": "",
                "productInfo": {
                  "overdueDayRate": "0.07",
                  "repayMethod": "FIXED_INSTALLMENT",
    ...
    def update_user_credit_apply(self):
        api = "/mozhibeiyin/tianbang/limit.apply"
        mode = '''{
                  "code": 0, //0-成功，  其他重试
                  "message": "测试进件",
                  "data": {
    ...
    def update_user_credit_apply_result_success(self):
        api = "/mozhibeiyin/tianbang/credit.apply.result"
        mode = '''{
                  "code": 0,
                  "message": "成功",
                  "data": {
    ...
    def update_user_loan_apply_success(self):
        api = "/mozhibeiyin/tianbang/loan.apply"
        mode = '''{
                      "code": 0, //0-成功，其他重试
                      "message": "成功",
                      "data": {
    ...
    def update_user_loan_result_success(self, asset_info):
        api = "/mozhibeiyin/tianbang/loan.result"
    ...
    def update_repayPlanquery_success(self, asset_info):
        api = "/mozhibeiyin/tianbang/loan.record.detail"
    ...
    def update_contractpush_ftp_success(self):
        api = "/capital/ftp/upload/beiyin_tianbang"
        mode = '''{
                  "code": 0,
                  "message": "",
                  "data": {
