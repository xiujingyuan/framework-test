...
class JinmeixinDaqinMock(Easymock):

    def update_user_check(self, ifCanPush='Y'):
        """
        准入接口
        :return:
        """
        api = "/chongtian/jinmeixin_daqin/user/check"
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_bindCard_ceck(self, needBinding='Y'):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/bindCard/check'
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_bindCard_verify(self):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/bindCard/verify'
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_bindCard_confirm(self):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/bindCard/confirm'
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_user_infoPush(self, code='000000', msg='成功'):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/user/infoPush'
        body = {
            "code": code,
            "msg": msg,
            "data": None
    ...
    def update_user_infoPushQuery(self, code='000000', msg='成功', handleStatus='SUC', failMsg=''):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/user/infoPushQuery'
        body = {
            "code": code,
            "msg": msg,
            "data": {
    ...
    def update_loan_trial(self, code='000000', msg='成功'):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/loan/calc'
        body = {
    ...
    def update_loan_request(self, item_no, code='000000', msg='成功'):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/loan/request'
        body = {
            "code": code,
            "msg": msg,
            "data": {
    ...
    def update_loan_results_query(self, item_no, code='000000', msg='成功', applyStatus='LOAN_PASSED',
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/loan/results/query'
        body = {
            "code": code,
            "msg": msg,
            "data": {
                "loanOrderNo": item_no + "_JMX",
    ...
    def upate_repayplan_query(self, asset_info, item_no):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/repayplan/query'
    ...
    def updat_contract_query(self):
        ...
        :return:
        """
        api = '/chongtian/jinmeixin_daqin/contract/query'
        body = {
              "code": "000000",
              "msg": "成功",
              "data": [{
                  ...
                  "contractId": "5962002",
                  "contractPath": "https://ndmicro-bohai.oss-cn-beijing.aliyuncs.com/JMX/V1/202204/eed7824320c94df292325615b203024a-0-20220415173137330197.pdf",
                ...
                },
                {
                  ...
                  "contractId": "5962289",
                  "contractPath": "https://ndmicro-bohai.oss-cn-beijing.aliyuncs.com/JMX/V1/202204/eed7824320c94df292325615b203024a-0-20220415173137330197.pdf",
                  "contractType": "GUARANTEE_SERVICE"
                },
                {
