...
class HebeiWenshunTsMock(Easymock):
    ...
    def update_file_notice(self):
      api = '/zhongke/hebei_wenshun_ts/channelfilesyncnotice'
      body = {
          "code": 0,
          "message": "success",
          "data": {
    ...
    def update_credit_apply(self, itemno, respcode='0000', respmesg='交易接收成功'):
        api = '/zhongke/hebei_wenshun_ts/creditapply'
        body = {
          "code": 0,
          "message": "success",
          "data": {
    ...
    def update_credit_query(self, itemno, respcode='9999', respmesg='交易处理成功', result='1'):
        api = '/zhongke/hebei_wenshun_ts/creditquery'
        body = {
          "code": 0,
          "message": "success",
          "data": {
    ...
    def update_loan_apply(self, respcode='0000', respmesg='交易接收成功'):
        api = '/zhongke/hebei_wenshun_ts/loanapply'
        body = {
          "code": 0,
          "message": "success",
          "data": {
    ...
    def update_loan_query(self,itemno, respcode='9999', respmesg='交易处理成功', status='1'):
        api = '/zhongke/hebei_wenshun_ts/loanquery'
        body = {
          "code": 0,
          "message": "success",
          "data": {
    ...
    def update_repayplan_query(self, itemno, asset_info):
        ...
        api = '/zhongke/hebei_wenshun_ts/repayplanquery'
        body = {
          "code": 0,
          "message": "success",
          "data": {
