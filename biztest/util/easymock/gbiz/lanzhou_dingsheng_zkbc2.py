...
class LanZhouDingShengZkbcMock(Easymock):
    def update_pre_tied_card(self):
        api = "/lanzhou2/preTiedCard"
        mode = '''{
    ...
    def update_repay_plan(self, asset_info):
        api = "/lanzhou2/repaymentPlanQuery"
