...
class JinchengHanchenMock(Easymock):
    ...
    def update_user_check(self, ifCanPush='Y'):
        ...
        :return:
        """
        api = "/chongtian/jincheng_hanchen/user/check"
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_bindCard_ceck(self, needBinding='Y'):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/bindCard/check'
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_bindCard_verify(self):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/bindCard/verify'
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_bindCard_confirm(self):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/bindCard/confirm'
        body = {
            "code": "000000",
            "msg": "成功",
            "data": {
    ...
    def update_user_infoPush(self, code='000000', msg='成功'):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/user/infoPush'
        body = {
            "code": code,
            "msg": msg,
            "data": None
    ...
    def update_user_infoPushQuery(self, code='000000', msg='成功', handleStatus='SUC', failMsg=''):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/user/infoPushQuery'
        body = {
            "code": code,
            "msg": msg,
            "data": {
    ...
    def update_loan_trial(self, code='000000', msg='成功'):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/loan/calc'
        body = {
    ...
    def update_loan_request(self, item_no, code='000000', msg='成功'):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/loan/request'
        body = {
            "code": code,
            "msg": msg,
            "data": {
    ...
    def update_loan_results_query(self, item_no, code='000000', msg='成功', applyStatus='LOAN_PASSED',
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/loan/results/query'
        body = {
            "code": code,
            "msg": msg,
            "data": {
                "loanOrderNo": item_no + "_JC",
    ...
    def upate_repayplan_query(self, asset_info, item_no):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/repayplan/query'
    ...
    def updat_contract_query(self):
        ...
        :return:
        """
        api = '/chongtian/jincheng_hanchen/contract/query'
        body = {
              "code": "000000",
              "msg": "成功",
              "data": [{
