...
def get_run_cases():
    ...
    rets = FinlabCaseBiz.Query(project_system_name=USERS_OPTION_DICT["project_system_name"])
...
if __name__ == "__main__":
    pytest.main("TestClass.py --capture=no --project_system_name=stb_system_sqb")
