...
class Assert(object):
    ...
    @classmethod
    def assert_equal(cls, excepts, actual, msg):
        unittest.TestCase().assertEqual(excepts, actual, msg)
        pass

    @classmethod
    def assert_not_equal(cls, excepts, actual, msg):
        unittest.TestCase().assertNotEqual(excepts, actual, msg)
        pass

    @classmethod
    def assert_in(cls, member, container, msg):
        unittest.TestCase().assertIn(member, container, msg)
        pass

    @classmethod
    def assert_not_in(cls, member, container, msg):
        unittest.TestCase().assertNotIn(member, container, msg)
        pass

    @classmethod
    def assert_match(cls, text, expected_regex, msg):
        unittest.TestCase().assertRegex(text, expected_regex, msg)
        pass

    @classmethod
    def assert_not_match(cls, text, expected_regex, msg):
        unittest.TestCase().assertNotRegex(text, expected_regex, msg)
        pass

    @classmethod
    def assert_match_json(cls, except_json, actual_json, msg):
    ...
    @classmethod
    def assert_list_equal(cls, excepts, actual, msg):
        unittest.TestCase().assertListEqual(excepts, actual, msg)
        pass
