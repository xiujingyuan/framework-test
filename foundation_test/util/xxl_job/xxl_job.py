...
from foundation_test.config.rbiz.url_config import xxl_job_url, global_xxl_job_new_url, \
    global_feilvbin_xxl_job_url, global_taiguo_xxl_job_url, global_yinni_xxl_job_url, global_yindu_xxl_job_url, \
    xxl_job_url_k8s
from foundation_test.util.tools.tools import parse_resp_body
...
class XxlJob:
    ...
    def get_url(self):
        ...
        elif self.type == "global_yinni_xxl_job":
            self.base_url = global_yinni_xxl_job_url
        elif self.type == "global_taiguo_xxl_job":
            self.base_url = global_taiguo_xxl_job_url
        elif self.type == "global_feilvbin_xxl_job":
            self.base_url = global_feilvbin_xxl_job_url
